...
import { Pressable, SafeAreaView, StatusBar, Text, useColorScheme, useWindowDimensions, View } from 'react-native';
        ...
        async pressed => {
            ...
            if (pressed === 'equal') {
                if (tempNum !== 0 && lastAction !== null) {
                    ...
                    const result = await executeCalculator(lastAction, tempNum, parseInt(inputNum, 10));
                    console.log(result);
            ...
            if (resultNum !== '') {
                ...
                setTempNum(parseInt(inputNum, 10));
                setInputNum('');
            } else {
                const result = await executeCalculator(pressed, tempNum, parseInt(inputNum, 10));
                console.log(result);
                setResultNum(result.toString());
                setTempNum(0);
            }
